...
export class WorkoutLists implements OnInit { 
  ...
  workouts: Workout[] = [
    { id: 1, title: 'Running', type: 'Cardio', duration: 30, image: 'pages/workout-lists/running.jpg' }, // Sesuaikan path image
    { id: 2, title: 'Bench Presses', type: 'Muscular', duration: 20, image: 'pages/workout-lists/bench.jpg' },
    { id: 3, title: 'Overhead Pressed', type: 'Muscular', duration: 30, image: 'pages/workout-lists/overhead.jpg' },
    { id: 4, title: 'Swimming', type: 'Cardio', duration: 30, image: 'pages/workout-lists/swim.jpg' },
    { id: 5, title: 'Dancing', type: 'Cardio', duration: 40, image: 'pages/workout-lists/dance.jpg' },
    { id: 6, title: 'Deadlifts', type: 'Muscular', duration: 20, image: 'pages/workout-lists/deadlift.jpg' },
  ];
