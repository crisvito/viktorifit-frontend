...
import { BmiCardComponent } from '../../shared/components/bmi-card/bmi-card';
...
userProfile: UserWellnessProfile = {
    ...
    bodyFat: {
      percentage:'18-20%',
      category: 'Fitness',
      image:'assets/recommendation/Athletic.png',
    },
    gender: 'Female',
    program: {
      title: 'Weight Loss',
      ...
      image: 'assets/recommendation/cardio.png'
    },
    level: 'Beginner',
    freq: 4,
};
...
//MEALS
  ...
  mlDatabaseMock: Record<number, Meal[]> = {
    1: [
      { name: 'Super Steak & Potatoes', calories: 1800, protein: '120g' , image: 'assets/steak.png', porsi:'1.0 Porsi Besar'}
    ],
    2: [
      { name: 'Avocado Toast & Eggs', calories: 800, protein: '40g', image: 'assets/toast.png', porsi:'1.0 Piring' },
      { name: 'Salmon & Quinoa', calories: 1000, protein: '60g', image: 'assets/salmon.png', porsi:'1.0 Mangkok' }
    ],
    3: [
      { name: 'Oatmeal & Berries', calories: 500, protein: '20g', image: 'assets/oatmeal.png', porsi:'1.0 Mangkok' },
      { name: 'Grilled Chicken Breast', calories: 700, protein: '50g', image: 'assets/chicken.png', porsi:'1.0 Piring' },
      { name: 'Tuna Salad', calories: 600, protein: '40g', image: 'assets/tuna.png', porsi:'1.0 Mangkok' }
    ],
    4: [
      { name: 'Breakfast Omelette', calories: 400, protein: '20g', image: 'assets/omelette.png', porsi:'1.0 Piring' },
      { name: 'Lunch Beef Bowl', calories: 500, protein: '30g', image: 'assets/beef.png', porsi:'1.0 Mangkok' },
      { name: 'Afternoon Snack Bar', calories: 300, protein: '15g', image: 'assets/snack.png', porsi:'1.0 Bungkus' },
      { name: 'Dinner Fish Fillet', calories: 600, protein: '35g', image: 'assets/fish.png', porsi:'1.0 Piring' }
    ],
    5: [
      { name: 'Small Breakfast', calories: 300, protein: '15g', image: 'assets/img1.png', porsi:'0.5 Piring' },
      { name: 'Mid-Morning Snack', calories: 400, protein: '25g', image: 'assets/img2.png', porsi:'1.0 Buah' },
      { name: 'Lunch Portion', calories: 400, protein: '25g', image: 'assets/img3.png', porsi:'0.5 Piring' },
      { name: 'Pre-Workout', calories: 300, protein: '15g', image: 'assets/img4.png', porsi:'1.0 Shake' },
      { name: 'Dinner Light', calories: 400, protein: '20g', image: 'assets/img5.png', porsi:'0.5 Piring' }
    ]
  };
